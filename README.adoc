...
IMPORTANT: A inscrição em um mini-curso não garante a vaga, apenas o credenciamento que será feito por ordem de chegada. Por isso, chegue com antecedência para garantir seu lugar.[color: red]
