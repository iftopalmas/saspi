...
Para participar da gincana Free Fire, você deve fazer a inscrição neste link: https://forms.gle/vnCKLFReKdGkwMXf6[inscrição Free Fire]. O formulário para inscrição estará disponível no dia 18/10 após as instruções informadas na abertura do evento.
...
Para participar da gincana LOL, o grupo (5 jogadores titulares, 5 reservas) deve fazer a inscrição neste link: https://forms.gle/qwHU2Cpc6LECi7aF7[inscrição equipe LOL]. O formulário para inscrição estará disponível no dia 18/10 após as instruções informadas na abertura do evento.  
