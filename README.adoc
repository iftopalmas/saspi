...
Para participar da gincana LOL, o grupo (5 jogadores titulares, 5 reservas) deve fazer a inscrição neste link: https://forms.gle/qwHU2Cpc6LECi7aF7[inscrição equipe LOL]. O formulário para inscrição estará disponível após o dia {termino_inscricao} após as instruções informadas na abertura do evento.  
...
Informação importante (https://drive.google.com/file/d/1H3hCkdufiD9gznNV7nJJSIXclyIpcNbb/view?usp=sharing[Download do regulamento]):
