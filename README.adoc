...
| 18:30 às 19:30 | Palestra ( APRESENTAÇÃO CULTURAL ): CONECTA PALMAS ( COMPOSIÇÃO DA MESA E ABERTURA). Palestrante - CONECTA PALMAS |Não será transmitido. | {localiftoauditorio}[Local do evento], Auditorio central do IFTO-palmas.
