...
|| TARDE||
| 14:00 às 17:30 | GINCANA - L.O.L, Valorant, Free-Fire, Tênis de Mesa, Xadrez|{youtube}[Ver transmissão] | {localiftoauditorio}[Local do evento], Local de encontro Auditorio central IFTO-palmas.
|| NOITE||
| 19:00 às 22:30 | GINCANA - L.O.L, Valorant, Free-Fire, Tênis de Mesa, Xadrez|{youtube}[Ver transmissão] | {localiftoauditorio}[Local do evento], Local de encontro Auditorio central IFTO-palmas.|
...
|| NOITE||
|19:00 às 20:40 | Mesa Redonda: Segurança Cibernética e Virtual. Palestrante - Claudio de Castro Monteiro, Vinícius de Miranda Rios, Carlos Adriano, Ricardo Loureiro Soares, Talles Martins Moura .|  Não será transmitido. | {localiftoauditorio}[Local do evento], Auditorio central do IFTO-palmas.
|20:50 às 22:30 | Mesa Redonda: Cenário atual do mercado tocantinense de TI: Necessidades e Evoluções. Palestrantes - Darley Passarin, Danilo Silva.| Não será transmitido. | {localiftoauditorio}[Local do evento], Auditorio central do IFTO-palmas.
